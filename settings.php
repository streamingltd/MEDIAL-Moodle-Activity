...
if (optional_param('section', null, PARAM_ALPHA) == 'modsettinghelixmedia') {
    $information = "<p>". get_string("repo_migrate_message", "mod_helixmedia") . "</p>" .
                   "<p style='text-align:center;font-weight:bold;'>" .
                   "<a href='" . $CFG->wwwroot."/mod/helixmedia/migrate.php'>" . get_string("repo_migrate_link", "mod_helixmedia") . "</a>" .
                   "</p>";
    $settings->add(
        new admin_setting_heading(
            'helixmedia/repo_migrate',
            get_string("repo_migrate_title", "mod_helixmedia"),
            $information
        )
    );
}
